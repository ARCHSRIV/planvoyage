...
const CorporateEventSchedule5 = ({ navigation }: Props) => {
    ...
    <View style={{ minHeight: 750 }}>
        ...
        <View style={{
                ...
                <Text style={styles.title}>NEED EXTRA HANDS </Text>


                <Text style={styles.title}>Will you need Hospitality Staff ?</Text>
                ...
                <View style={styles.content}>
                <Text style={styles.title}>And When ?</Text>
                <TextInput label="Select the programme date" returnKeyType="done"/>
                <Calender/>
                </View>

                <View>
                    <Text style={styles.title}>Ball Park the Timeframe</Text>
                    <CustomRangeSlider />
                </View>

                <View>
                    <Text style={styles.title}>Please Describe The Basic Duties</Text>
                    <TextInput label="Text box..." returnKeyType="done"/>
                </View>
...
export default memo(CorporateEventSchedule5);