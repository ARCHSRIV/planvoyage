...
const CorporateEventSchedule3 = ({ navigation }: Props) => {
    ...
    return (
        <KeyboardAwareScrollView>
            <View style={{ minHeight: 750 }}>
                ...
                <Text style={styles.title}>EXPLORE YOUR CULINARY SCENE</Text>


                <View>
                    <Text style={styles.title}>Please provide ballpark group size per each restaurant</Text>
                    <CustomRangeSlider />
                </View>

                <Text style={styles.title}>Are you interested in transportation for your dine arounds ?</Text>
...
export default memo(CorporateEventSchedule3);