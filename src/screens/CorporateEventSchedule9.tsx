...
const CorporateEventSchedule9 = ({ navigation }: Props) => {
    ...
    <View style={{ minHeight: 750 }}>
        ...
        <View>
            <Text style={styles.title}>EVEN THOUGH NO ONE READS</Text>
            <Text style={styles.title}>LETS TALK SIGNAGE</Text>
        </View>

        <Text style={styles.title}>Are you interested in custom signs for any aspects of your event ?</Text>
...
export default memo(CorporateEventSchedule9);