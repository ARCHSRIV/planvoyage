...
const CorporateEventSchedule7 = ({ navigation }: Props) => {
    ...
    <View style={{ minHeight: 750 }}>
        ...
        <View style={{display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20,
                    ...
                    <View style={{ width: 'auto', flexDirection: 'row' }}>
                        ...
                        <TouchableOpacity onPress={() => navigation.navigate('CorporateWhen')}>
                            ...
                            <Text>When ,Where And Howmany ?</Text>
                        </TouchableOpacity>

                        <TouchableOpacity onPress={() => navigation.navigate('explore')}>
                            <View style={styles.progressbox}>
                                <Image style={styles.image} source={require('../assets/when.png')} />
                                <Text style={styles.progressboxtext}>LISTENING</Text>
                            </View>
        ...
        <Text style={styles.title}>WHAT ARE YOU LISTENING TO ?</Text>
        ...
        <View style={styles.radiocontainer}>
                    ...
                    <Text style={{ paddingTop: 6 }}> Acoustic soloist/duet</Text>
        </View>
        ...
        <View style={styles.radiocontainer}>
                    <RadioButton
                        ...
                        status={checked === 'Yes' ? 'checked' : 'unchecked'}
                        onPress={() => setChecked('Yes')} />
                    <Text style={{ paddingTop: 6 }}>Live DJ</Text>
        </View>
        ...
        <Text style={styles.title}>Would you like suggestions for interactive entertainment ?</Text>
                <View style={styles.radiocontainer}>
                    <RadioButton
                        value="Yes"
                        status={checked === 'Yes' ? 'checked' : 'unchecked'}
        ...
        <TextInput label="Please provide as much detail as possible" returnKeyType="done"/>
                 ...
                 <View style={{
                    ...
                    padding: 20, margin: 0 }}>
                    <View style={{ width: 'auto', flexDirection: 'row' }}>
                        <Button onPress={() => navigation.navigate('CorporateEventSchedule6')} mode="contained" style={styles.button}>
                            BACK
                        </Button>
                        <Button onPress={() => navigation.navigate('CorporateEventSchedule8')} mode="contained" style={styles.button}>
                            NEXT
                        </Button>
                    </View>
                </View>
...
export default memo(CorporateEventSchedule7);
