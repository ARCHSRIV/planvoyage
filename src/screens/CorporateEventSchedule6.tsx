...
const CorporateEventSchedule6 = ({ navigation }: Props) => {
    return(
    ...
    <View style={{ minHeight: 750 }}>
                    ...
                    <View style={{ width: 'auto', flexDirection: 'row' }}>
                        ...
                        <TouchableOpacity onPress={() => navigation.navigate('explore')}>
                            <View style={styles.progressbox}>
                                ...
                                <Text style={styles.progressboxtext}>VISION</Text>
                            </View>
                            <Text >What's your vision ?</Text>
                        </TouchableOpacity>
        ...
        <View style={{
                    ...
                    <View style={{ width: 'auto', flexDirection: 'row' }}>
                        ...
                        <Button onPress={() => navigation.navigate('CorporateEventSchedule7')} mode="contained" style={styles.button}>
                            NEXT
                        </Button>
                    </View>
                </View>
    ...
    export default memo(CorporateEventSchedule6);