...
const CorporateEventSchedule2 = ({ navigation }: Props) => {
    ...
    return (
        <KeyboardAwareScrollView>
            <View style={{ minHeight: 750 }}>
                ...
                <View style={{
                    ...
                    <View style={{ width: 'auto', flexDirection: 'row' }}>
                        ...
                        <TouchableOpacity onPress={() => navigation.navigate('Lets Talk')}>
                            <View style={styles.progressbox}>
                    ...
                    <Text style={styles.title}>LET'S TALK VENUE</Text>

                    <View>
                        <Text style={styles.title}>How far do you want to travel ?</Text>
                        <CustomRangeSlider />
                    </View>

                    <View>
                        <Text style={styles.title}>How many guest do you expect at this event ?</Text>
                        <CustomRangeSlider />
                    </View>

                    <Text style={styles.title}>Describe your demographic in a few words so we know who's coming</Text>
                    <View style={styles.content}>
                        <TextInput label="Type here" returnKeyType="done" />
                    </View>

                    <Text style={styles.title}>Will you want to provide transportation to and from the venue ?</Text>
            ...
            export default memo(CorporateEventSchedule2);