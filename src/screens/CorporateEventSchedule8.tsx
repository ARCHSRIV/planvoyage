...
const CorporateEventSchedule8 = ({ navigation }: Props) => {
    return(
        <KeyboardAwareScrollView>
    <View style={{ minHeight: 750 }}>
        <GlobalHeader primaryHeading="CORPORATE" secondaryHeading="- Cheers How would like the bar ?" />
        <View>
                    ...
                    <View style={{ width: 'auto', flexDirection: 'row' }}>
                        ...
                        <TouchableOpacity onPress={() => navigation.navigate('explore')}>
                            <View style={styles.progressbox}>
                                ...
                                <Text style={styles.progressboxtext}>CHEERS</Text>
                            </View>
                            <Text >Cheers How would like the bar service ?</Text>
                        </TouchableOpacity>
        ...
        <Text style={styles.title}>CHEERS HOW WOULD LIKE THE BAR SERVICE ?</Text>
        ...
        <View style={styles.radiocontainer}>
                    ...
                    <Text style={{ paddingTop: 6 }}> Cash Bar</Text>
        </View>
        ...
        <View style={styles.radiocontainer}>
                    <RadioButton
                        ...
                        status={checked === 'Yes' ? 'checked' : 'unchecked'}
                        onPress={() => setChecked('Yes')} />
                    <Text style={{ paddingTop: 6 }}>Spending Limit</Text>
        </View>
        ...
        <View style={styles.radiocontainer}>
                    <RadioButton
                        ...
                        status={checked === 'Yes' ? 'checked' : 'unchecked'}
                        onPress={() => setChecked('Yes')} />
                    <Text style={{ paddingTop: 6 }}>Open Bar</Text>
        </View>
...
export default memo(CorporateEventSchedule8);